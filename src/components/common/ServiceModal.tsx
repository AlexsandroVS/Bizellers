              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-5 bg-white/50 backdrop-blur-sm overflow-y-auto flex-1">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:border-verde-lima focus:ring-2 focus:ring-verde-lima/20 focus:outline-none transition-all bg-white shadow-sm hover:shadow-md"
                    />
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:border-verde-lima focus:ring-2 focus:ring-verde-lima/20 focus:outline-none transition-all resize-none bg-white shadow-sm hover:shadow-md"
                  />
                </div>
